...
const READINGS: Record<string, HoroscopeReading> = {
  ...
  おうし座: {
    ...
    relationship:
      'ゆっくり時間をかけて信頼を育てるタイプ。一度心を許した相手はとことん大切にします。ただ、居心地のよさを求めすぎて刺激のある出会いを避けてしまうことも。たまには小さな冒険を一緒に。',
    lifeTheme:
  ...
  ふたご座: {
    ...
    relationship:
      '会話が弾む相手に強く惹かれます。ただ「話が合う」と「相性がいい」は別物。言葉の上手さよりも、その奥にある誠実さを見つめると、長く続く関係に出会えます。',
    lifeTheme:
  ...
  しし座: {
    ...
    essence:
      'あなたの本質は「自分らしく堂々と輝き、まわりを照らす力」。表現することが好きで、人の中心にいると自然と元気になる。誇り高く、まっすぐで、関わる人を明るくする太陽のような存在です。',
    strengths:
  ...
  てんびん座: {
    ...
    essence:
      'あなたの本質は「人と人の間に調和を生み出す力」。公平さを大切にし、対立よりも理解を選ぶ。美しいもの、心地よい関係、洗練された空気に敏感な、バランス感覚の達人です。',
    strengths:
  ...
  さそり座: {
    ...
    strengths:
      '洞察力・集中力・誠実さ。人が見落とす本音やリスクを直感的に見抜く力があります。困っている人に深く寄り添える情の厚さも、あなたが本物の信頼を集める理由です。',
    growth:
      '感情を内に溜め込みやすく、ひとりで抱えすぎてしまう傾向が。猜疑心が強くなり、人を試してしまうことも。すべてを見せなくて大丈夫。信頼できる一人に心を開くことから、重荷は軽くなっていきます。',
    relationship:
  ...
  いて座: {
    ...
    strengths:
      '楽観性・行動力・正直さ。失敗を恐れず挑戦できる明るさがあり、その姿勢は周りに元気を与えます。心に思ったことをまっすぐ伝える率直さも、あなたの愛される個性です。',
    growth:
      '好奇心が強いぶん、始めることは得意でも「やり切る」前に次へ向かいたくなることが。飽きっぽさや、ときの率直すぎる言葉が課題になることも。ひとつのことを最後まで完走する経験が、あなたの自由をさらに本物にします。',
    relationship:
      '束縛を嫌い、自由でいたい気持ちが強いタイプ。ただ自由すぎると相手を不安にさせることも。ときどき安心感を言葉や行動で伝えると、自由と信頼が両立します。',
    lifeTheme:
  ...
  やぎ座: {
    ...
    essence:
      'あなたの本質は「目標に向かって着実に積み上げる力」。地に足をつけ、現実を見すえながら、長い時間をかけて確かな成果を築いていく。責任感が強く、信頼を何より大切にする人です。',
    strengths:
    ...
    lifeTheme:
      '「成果だけでなく、その過程の自分も認める」こと。山頂を目指す道のりそのものが、すでにあなたの価値です。',
  },
  みずがめ座: {
    ...
    strengths:
      '独創性・先見性・公平さ。誰も思いつかない発想で物事を新しくする力があります。偏見にとらわれず、人を肩書きでなく中身で見られるフェアさも、あなたの大切な美点です。',
    growth:
  ...
  うお座: {
    ...
    strengths:
      '共感力・想像力・優しさ。相手の気持ちを言葉にならない部分まで受け取れる感受性があります。見返りを求めずに人を思いやれる無償の愛も、あなたが愛される理由です。',
    growth:
      '感受性が豊かなぶん、現実と空想の境目が曖昧になったり、つらい現実から逃げたくなることも。人に流されやすい一面も。地に足をつける時間を持つこと。あなたの優しさは、自分を犠牲にしなくても十分に届きます。',
    relationship:
