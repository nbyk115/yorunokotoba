...
const READINGS: Record<string, HoroscopeReading> = {
  おひつじ座: {
    ...
    essence:
      'あなたの本質は「自分から動き出す力」🔥。誰かの号令を待たず、思い立った瞬間にもう一歩目を踏み出してる。新しい場所、新しい挑戦、誰もやっていないこと。そこにワクワクを感じるのがあなたの生まれ持った気質だと思う。',
    strengths:
  ...
  おうし座: {
    ...
    essence:
      'あなたの本質は「心地よさを大切にし、地に足をつけて生きる力」🌿。急がず、流されず、自分が「これは本物だ」と感じたものだけを手元に残していく。五感が豊かで、美しいものや美味しいもの、安心できる空間に深い喜びを感じる人だよ。',
    strengths:
  ...
  ふたご座: {
    ...
    essence:
      'あなたの本質は「知りたい、伝えたいという尽きない好奇心」🔍。頭の回転が速く、いくつもの興味を同時に抱えながら、軽やかに世界を行き来する🦋。新しい情報、新しい人、新しい話題。そのすべてがあなたのエネルギー源だよ。',
    strengths:
  ...
  かに座: {
    ...
    essence:
      'あなたの本質は「大切な人を守り、安心できる居場所をつくる力」🏡。感受性が豊かで、相手の気持ちを自分のことのように受け取れるんだよね。家族や仲間との心のつながりに、何よりの幸せを感じてると思う。',
    strengths:
  ...
  しし座: {
    ...
    essence:
      'あなたの本質は「自分らしく堂々と輝き、まわりを照らす力」☀️。表現することが好きで、人の中心にいると自然と元気になる。誇り高く、まっすぐで、関わる人を明るくする太陽のような存在だと思う。',
    strengths:
  ...
  おとめ座: {
    ...
    essence:
      'あなたの本質は「細かいズレを見逃さず、もっとよくしていく力」🔎。細部に気づき、人の役に立つことに静かな喜びを感じる。理想を現実に近づけるために、地道な努力を惜しまない誠実な人だと思う。',
    strengths:
  ...
  てんびん座: {
    ...
    essence:
      'あなたの本質は「人と人の間に調和を生み出す力」⚖️。公平さを大切にし、対立よりも理解を選ぶ🕊️。美しいもの、心地よい関係、洗練された空気に敏感な、バランス感覚の達人だよ。',
    strengths:
  ...
  さそり座: {
    ...
    essence:
      'あなたの本質は「物事の奥深くまで潜り、本質をつかむ力」🌊。表面的なつながりでは満足できず、人や物事の核心に触れたいと願う。一度信じたものには、とことん情熱を注げる人だよ。',
    strengths:
  ...
  いて座: {
    ...
    essence:
      'あなたの本質は「まだ見ぬ世界へ向かう、尽きない探求心」🏹。型にはまることを嫌い、いつも「もっと面白いことがあるはず」と前を見てる。自由でおおらか、希望を語ることが得意な人だよ。',
    strengths:
  ...
  やぎ座: {
    ...
    essence:
      'あなたの本質は「目標に向かって着実に積み上げる力」⛰️。地に足をつけ、現実を見すえながら、長い時間をかけて確かな成果を築いていく。責任感が強く、信頼を何より大切にする人だよ。',
    strengths:
  ...
  みずがめ座: {
    ...
    essence:
      'あなたの本質は「みんなが疑わないことに、静かに疑問を持つ感覚」💡。流行や常識をそのまま受け入れず、「本当にそうかな」と問い直す🔭。自由を愛し、新しい未来を思い描く、生まれ持った癖だと思う。',
    strengths:
  ...
  うお座: {
    ...
    essence:
      'あなたの本質は「目に見えないものを感じとる、繊細な感受性」🐚。人の痛みにそっと寄り添い、世界を優しいまなざしで包む🌊。想像力が豊かで、夢や芸術と深くつながれる人だよ。',
    strengths:
