...
const COLORS: readonly LuckyColor[] = [
  { v: 'ピンク', hex: '#E8627C', reason: '恋愛運UP。リップに仕込んで' },
  { v: 'ラベンダー', hex: '#B08ACF', reason: '直感が冴える。選択に迷ったら' },
  { v: 'ゴールド', hex: '#D4A853', reason: 'お金まわりの色。アクセやネイルに' },
  { v: '水色', hex: '#5A9AC0', reason: 'コミュ力UP。人と話す日に' },
  { v: 'オレンジ', hex: '#E07070', reason: '行動力の色。チークに仕込んで' },
  { v: '白', hex: '#F5F0EB', reason: 'リセットの色。部屋に白いものを' },
  { v: 'グリーン', hex: '#5BA87C', reason: '癒しと回復の色。植物を飾って' },
  { v: 'ワインレッド', hex: '#8B2252', reason: '強さと魅力が増す色。勝負の日に' },
  { v: 'スカイブルー', hex: '#87CEEB', reason: '発信運UP。SNSを更新して' },
  { v: 'サーモンピンク', hex: '#FA8072', reason: '出会い運の色。外出前にチェック' },
  { v: 'イエロー', hex: '#E3A84A', reason: '知性と直感の色。勉強や分析の日に' },
