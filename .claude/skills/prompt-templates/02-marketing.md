...
## P00. 研究プロトコル 6 プロンプト (Claude PhD レベル文献レビュー、2026-05-15 統合 PR #200)

> 出典: ユーザー提示テキスト 2026-05-15 (INFERENCE、一次出典 fetch 未実施)。market-researcher + competitive-analyst + feedback-synthesizer 運用強化、関根さん / 水野さん案件の文献レビュー + 知識マップ構築手法。

### 1. 取り込みプロトコル (初回アップロード時)

```
[トピック] に関する [X] 本の論文を共有します。
何かを尋ねる前に、以下を実行してください:
1. すべての論文を著者 + 年 + 核心的主張を 1 文でリストアップ
2. 共有された前提に基づくクラスターにグループ化
3. 他の論文と矛盾する論文をフラグ立て
要約しないでください。全体像をマッピングしてください。
```

### 2. 矛盾発見者

```
アップロードされたすべての論文において、2 人以上の著者が直接矛盾するすべての箇所を特定してください。
各矛盾について:
- 両方の立場を述べる / 論文の名前を挙げる / なぜ異なる意見か (方法論 / データセット / 時代) 説明
テーブル形式でフォーマット。
```
...
```
これらの論文全体で、最も多く引用されている 3 つの概念を選んでください。
各概念について: 誰が最初に導入 / 誰が批判 / 誰が洗練 / 現在のコンセンサス
知的系譜を家族の木のように見せてください。
```

### 4. ギャップスキャナー

```
すべての論文に基づき、まだ誰も完全に答えていない 5 つの研究質問を特定。
各ギャップ: なぜ存在するか (難易度 / ニッチ / 見落とし) / 最も近づいた既存論文 / 必要な方法論
```

### 5. 知識マップビルダー

```
この全文献の構造化された知識マップを作成。
フォーマット: 中央的主張 / 3-5 つの支持柱 / 2-3 つの論争地帯 / 1-2 つの最前線質問 / 新参者必読 3 論文
プローズではなく、クリーンなアウトラインで。
```

### 6. 「だから何？」テスト (最後、毎回)

```
専門家でない賢い人に 5 分で説明する想定:
1. 分野が証明したことの 1 文 / 2. まだ知られていないことの 1 つの正直な告白 / 3. 最も重要な実世界示唆 1 つ
専門用語なし、曖昧さなし、学術的前置きなし。
```

### ConsultingOS 適用

- market-researcher: 業界文献レビュー時の体系化
- competitive-analyst: 競合分析論文 / 業界レポート群の矛盾検出
- feedback-synthesizer: VOC 100+ 件の知識マップ化
- 関根さん N&Y Craft: 中小製造業 / OEM 文献の構造化
- 水野さん v4: AI vertical / vertical AI-OS 投資テーゼ補強研究
