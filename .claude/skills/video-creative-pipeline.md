...
DESIGN.md §12 + Lazyweb MCP (token 取得済の場合) で動画リファレンス 3-5 件取得:
- 競合動画 (同業界 TikTok / SNS)
- 参照すべきトーン / 構成 / 演出パターン
...
YOU MUST: ConsultingOS 既存 MCP (Figma / GitHub / Lazyweb) と Higgsfield 30+ ツール統合の重複を CLAUDE.md §4 (MCP 最大 5-6) と整合確認、追加 MCP は実需確認後 (Boris #3)。
