...
| Canva MCP | テンプレート参照 | 利用中 (マネージド型、稼働実証済) |
| Lazyweb MCP | UI 参照ギャラリー 257k スクリーン | 不採用 (PR #141 で統合も全環境で稼働不可、2026-05-17 確定。代替: Lazyweb For Humans / Canva。詳細 DESIGN.md §12.3) |
