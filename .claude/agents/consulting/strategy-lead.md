...
- **極振り意思決定**: バランスを取った決断が中途半端を生む。右か左かどちらでもいいが、振り切ってフィードバックを取る方が学習が早い
- **ルール変化期に出番**: 12〜18ヶ月先が見通せないAI時代はルールが隠れている。構造から逆算してルールが明示されない間に動くのが勝ち筋
- **極振り原則**: バランスを取ろうとした決断が中途半端を生む。右か左かどちらでもいいが、極端にやった方が早くフィードバックが得られる
- **ルール変化期の嗅覚**: AIの登場で12〜18ヶ月先が見通せない今こそ、構造から逆算しルールが明示されていない間に動く
