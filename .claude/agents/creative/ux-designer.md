...
2. Lazyweb For Humans（lazyweb.com 手動閲覧）/ Canva MCP / `refero.design` / WebSearch で関連参考画像 3-5 件取得（Lazyweb MCP は環境非互換で不採用、詳細 §12.3）
3. DESIGN.md §12.4 業界別推奨参照（IR / セールス / 1 枚絵 / LP / ダッシュボード）で補完
