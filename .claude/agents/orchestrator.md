...
|---|---|---|---|
| consulting-playbook | ハンドオフテンプレート・提案構造化 | 全フェーズ・エージェントへの指示設計時 | §2 商談設計 |
...
| ppt-presentation | 最終提案書・グローバルクレデンシャル | Phase 4（提案書化）時 | §4 Jobs6原則 |
...
| Phase 3（設計） | 法務・リスク | consulting-playbook §4 | 法規制チェック依頼時 |
| Phase 4（出力） | 提案書・資料化 | consulting-playbook §2 + ppt-presentation §4 | 最終成果物作成時 |
| 全フェーズ | ハンドオフ品質 | consulting-playbook §1（ハンドオフテンプレート） | 各エージェント引き継ぎ時 |
